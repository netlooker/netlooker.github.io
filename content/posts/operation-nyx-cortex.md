+++
title = "// OPERATION: NYX CORTEX"
date = "2026-03-29T00:00:00+00:00"
author = "Netlooker"
authorTwitter = ""
cover = "/img/operation-nyx-cortex.jpg"
tags = ["ai", "apple-silicon", "docker", "nix", "llm", "self-hosted", "privacy", "telegram"]
keywords = ["nyx", "openclaw", "qwen-coder", "nix flake", "self-hosted ai agent", "apple silicon", "local ai", "telegram bot", "deterministic build", "private ai agent"]
description = "Deploy a self-sovereign AI agent on Apple Silicon — reproducible to the cryptographic hash, wired to Telegram, running on your hardware. Zero corporate reach."
